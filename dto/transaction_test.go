...
func Test_should_return_error_when_transaction_type_deposit_or_withdrawal(t *testing.T) {
	// AAA
	//Arrange
	...
	//Assert
	if appError.Message != "Transaction type can only be either deposit or withdrawal" {
